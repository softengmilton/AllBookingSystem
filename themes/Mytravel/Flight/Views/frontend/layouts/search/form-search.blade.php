<form action="{{ route("flight.search") }}" class="form bravo_form_search mt-0 bravo_form d-flex mb-1 py-2" method="get">
    ...
    <div class="g-button-submit align-self-lg-center">
        <button class="btn width-lg-200 text-dark border-radius-2 font-weight-bold btn-md mb-xl-0 mb-lg-1 transition-3d-hover w-100 w-md-auto" type="submit"><i class="flaticon-magnifying-glass mr-2"></i> {{__("Search")}}</button>
    </div>
</form>
