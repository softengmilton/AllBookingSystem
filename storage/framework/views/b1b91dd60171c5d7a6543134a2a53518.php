<div class="bravo-form-search-all position-relative hero-block hero-v1 bg-img-hero-bottom text-center z-index-2" style="background-image: url('<?php echo e($bg_image_url); ?>') !important;">
