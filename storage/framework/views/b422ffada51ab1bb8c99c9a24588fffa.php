...
<?php $__currentLoopData = $attributes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if($key <= 2 ): ?>
                                ...
                                <div class="form-group d-flex align-items-center justify-content-between font-size-1 text-lh-md text-secondary mb-3">
                                    <div class="custom-control custom-checkbox">
                                        <input id="term_<?php echo e($term->id); ?>" class="custom-control-input"   <?php if(in_array($term->slug,$selected[$item->id] ?? [])): ?> checked <?php endif; ?> type="checkbox" name="attrs[<?php echo e($item->id); ?>][]" value="<?php echo e($term->slug); ?>">
    ...
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php /**PATH E:\Mytravel.2.4.2\themes/Mytravel/Layout/global/search/filters/attrs.blade.php ENDPATH**/ ?>